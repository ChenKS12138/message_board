...
!(function (e, t) {
            ...
            prepatch: function (t, n) {
                ...
                !(function (t, n, r, i, o) {
                    ...
                    if (
                        ...
                        ge(!1);
                        for (
                            var s = t._props, c = t.$options._propKeys || [], u = 0; u < c.length; u++
                        ) {
                            var l = c[u],
                                f = t.$options.props;
                            s[l] = Ee(l, f, n, t);
            ...
            if ((o(i) && (i = l.extend(i)), "function" == typeof i)) {
                ...
                if (r(i.options.functional))
                    return (function (t, r, i, o, a) {
                        ...
                        if (Array.isArray(p)) {
                            for (
                                var d = rt(p) || [], v = new Array(d.length), h = 0; h < d.length; h++
                            )
    ...
    var Vr,
        ...
        Wr = y(function (e) {
            if (
                ...
                return e;
            for (
                var t = e.charAt(0).toUpperCase() + e.slice(1), n = 0; n < qr.length; n++
            ) {
                var r = qr[n] + t;
                if (r in Vr) return r;
            }
    ...
    function Gr(e, r) {
        ...
        if (!(t(i.staticStyle) && t(i.style) && t(o.staticStyle) && t(o.style))) {
            ...
            var d = (function (e, t) {
                ...
                (n = Br(e.data)) && k(r, n);
                for (var o = e;
                    (o = o.parent);) o.data && (n = Br(o.data)) && k(r, n);
                return r;
            })(r, !0);
    ...
    function hi(e, t) {
        ...
        return (
            t === ri ?
            a > 0 && ((n = ri), (l = a), (f = o.length)) :
            t === ii ?
            u > 0 && ((n = ii), (l = u), (f = c.length)) :
            (f = (n = (l = Math.max(a, u)) > 0 ? (a > u ? ri : ii) : null) ?
                n === ri ?
                o.length :
                c.length :
                0), {
                ...
                e.data.show ||
                    ...
                    (fi(i, S),
                        ...
                        li(function () {
                            pi(i, S),
                                R.cancelled ||
                                (fi(i, N), F || (bi(D) ? setTimeout(R, D) : di(i, c, R)));
                        })),
                ...
                (!e.data.show &&
                    ...
                    (fi(i, u),
                        ...
                        li(function () {
                            pi(i, u),
                                w.cancelled ||
                                (fi(i, f), b || (bi($) ? setTimeout(w, $) : di(i, c, w)));
                        })),
                    v && v(i, w),
                    _ || b || w());
        }
    ...
    function Ai(e, t, n) {
        ...
        if (!i || Array.isArray(r)) {
            for (var o, a, s = 0, c = e.options.length; s < c; s++)
                if (((a = e.options[s]), i))
                    (o = j(r, Si(a)) > -1), a.selected !== o && (a.selected = o);
                else if (N(Si(a), r))
    ...
    function va(e, t) {
        ...
        if (
            (e.attrs && (n += "attrs:{" + _a(e.attrs) + "},"),
                ...
                e.events && (n += ia(e.events, !1) + ","),
                e.nativeEvents && (n += ia(e.nativeEvents, !0) + ","),
